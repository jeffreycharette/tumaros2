...
//Set variable for base address:
//base="file://localhost/Volumes/Photography/New%20ICA%20rev%205/web-content/"
base="http://sjica.org/new/"

//Menu Item 1 -----------------------
slideMenu.makeMenu('top','Home', base+'index.html')

//Menu Item 2 -----------------------
slideMenu.makeMenu('top','Exhibitions')
	slideMenu.makeMenu('sub','Current', base+'pages/exhibitions/current/current.html')
	slideMenu.makeMenu('sub','Future', base+'pages/exhibitions/future/future.html')
  	slideMenu.makeMenu('sub','Past', base+'pages/exhibitions/past/past.html')
		
//Menu Item 3 -----------------------
slideMenu.makeMenu('top','Programs & Events')
	slideMenu.makeMenu('sub','Talking Art',base+'pages/prog-events/talkingart/talking2006.html')
	
//Menu Item 4 -----------------------
slideMenu.makeMenu('top','About the ICA')
	slideMenu.makeMenu('sub','About the ICA',base+'pages/about/about.html')
	slideMenu.makeMenu('sub',"Director's Message",base+'pages/about/message.html')
	
//Menu Item 5 -----------------------
slideMenu.makeMenu('top','Support')
	slideMenu.makeMenu('sub','Membership', base+'pages/support/membership.html')
	slideMenu.makeMenu('sub','Giving to the ICA', base+'pages/support/giving.html')
	slideMenu.makeMenu('sub','Capital Campaign', base+'pages/capital/about_campaign.html')
//Menu Item 6 -----------------------
slideMenu.makeMenu('top','Capital Campaign')
	slideMenu.makeMenu('sub','About the Campaign',base+'pages/capital/about_campaign.html')
	slideMenu.makeMenu('sub','Our new building',base+'pages/capital/about_building.html')
	slideMenu.makeMenu('sub','How to Contribute',base+'pages/capital/contribute.html')
	
//Menu Item 7 -----------------------
slideMenu.makeMenu('top','Facility Rental',base+'pages/facilityrental/rental.html')

//Menu Item 8 -----------------------
//slideMenu.makeMenu('top','Join e-mail list',base+'pages/enews/elistform.html')
slideMenu.makeMenu('top','Join e-mail list','https://secure.cnchost.com/sjica.org/elistform.html')
