...
$tinybrowser['obfuscate'] = '325iwd46djd5f95f3!';
...
$tinybrowser['path']['image'] = '/uploaded/sjica/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploaded/media/'; // Media files location
...
$tinybrowser['tinymcecss'] = '/js/tiny_mce/themes/advanced/skins/thebigreason/dialog.css';
...
$tinybrowser['delayprocess'] = 2; // Value in seconds
?>
